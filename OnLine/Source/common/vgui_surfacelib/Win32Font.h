...
public:
	...
	// modify by andy
	void CWin32Font::GetCharRGBA(const wchar_t* text, int num, int rgbaX, int rgbaY, int rgbaWide, int rgbaTall, unsigned char *rgba, int tex_pitch, int tex_tall);
	...
	// returns the maximum num of characters
	int GetMaxCharNum();
	...
	void GetTextSize(const wchar_t* text, int& wide, int& tall);
