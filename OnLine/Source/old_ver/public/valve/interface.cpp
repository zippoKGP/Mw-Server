...
//
// $Header: /home/cvsroot/mythwar/src_main/public/valve/interface.cpp,v 1.2 2005/03/12 15:25:58 andy Exp $
// $NoKeywords: $
//
...
CreateInterfaceFn Sys_GetFactory(CSysModule* pModule)
{
	...
	HMODULE hDLL = reinterpret_cast<HMODULE>(pModule);
#ifdef _WIN32
	return reinterpret_cast<CreateInterfaceFn>(GetProcAddress(hDLL,
...
{
#ifdef _WIN32
	return static_cast<CreateInterfaceFn>(Sys_GetProcAddress(pModuleName,
											CREATEINTERFACE_PROCNAME));
#elif _LINUX
