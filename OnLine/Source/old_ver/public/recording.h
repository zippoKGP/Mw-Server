...
#define DEBUG_RECORD_FILE_LINE FILE_DEBUG_RECORD("%s, %d\n", __FILE__, __LINE__);
...
//////////////////////////////////////////////////////////////////////////
//
#define TRY_EXCEPT_RECORD(p) __try{p;} __except(true) { Msg("Except function : %s, %s, %d\n", #p, __FILE__, __LINE__); }

#define TRY_EXCEPT_RECORD_MSG(p, msg) __try{p;} __except(true) { Msg("Except function : %s, %s, %d\nmsg: %s"#p, __FILE__, __LINE__, msg); }
