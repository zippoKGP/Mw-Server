...
FIGHT_ACTION_SINGLE_SUCK_DATA fight_action_single_suck_data;
FIGHT_ACTION_SINGLE_VIRUS_DATA fight_action_single_virus_data;

FIGHT_ACTION_MULTI_PHYSICS_DATA fight_action_multi_physics_data;
FIGHT_ACTION_MULTI_PHYSICS_DOUBLE_DATA fight_action_multi_physics_double_data;
...
FIGHT_ACTION_MULIT_SUCK_DATA fight_action_multi_suck_data;
FIGHT_ACTION_MULTI_VIRUS_DATA fight_action_multi_virus_data;
FIGHT_ACTION_MULTI_STATUS_DATA fight_action_mulit_status_data;
// ---------
