...
extern PUBLIC_TITLE_DATA base_title_data;
...
extern FIGHT_COMMAND_DATA backup_character_fight_command_data;
extern FIGHT_COMMAND_DATA backup_baobao_fight_command_data;
