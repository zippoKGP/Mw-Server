...
const DWORD MIRRORVERTEX::FVF = D3DFVF_XYZ | D3DFVF_NORMAL;
...
class CMyD3DApplication : public CD3DApplication
{
    ...
    D3DMATERIAL9 m_mtrlMirrorMaterial;      // Material of the mirror
    D3DXMATRIXA16   m_matMirrorMatrix;         // Matrix to position mirror

    CD3DFile*    m_pTerrain;                // X file of terrain
    D3DXMATRIXA16   m_matTerrainMatrix;        // Matrix to position terrain

    CD3DFile*    m_pHelicopter;             // X file object to render
    D3DXMATRIXA16   m_matHelicopterMatrix;     // Matrix to animate X file object
...
HRESULT CMyD3DApplication::FrameMove()
{
    ...
    D3DXMATRIXA16 matRoll, matPitch, matRotate, matScale, matTranslate;
...
HRESULT CMyD3DApplication::InitDeviceObjects()
{
    ...
    if( pMesh )
    {
        ...
        pMesh->SetFVF( m_pd3dDevice, MESHVERTEX::FVF );
        ...
        for( DWORD i=0; i<dwNumVertices; i++ )
        {
            ...
            D3DXVECTOR3 v1(v01-v00);
            D3DXVECTOR3 v2(v10-v00);
            D3DXVECTOR3 n;
    ...
    if( FAILED( m_pd3dDevice->CreateVertexBuffer( 4*sizeof(MIRRORVERTEX),
                                       D3DUSAGE_WRITEONLY, MIRRORVERTEX::FVF,
                                          ...
                                          D3DFORMAT adapterFormat, D3DFORMAT backBufferFormat )
{
    ...
    // Make sure device supports directional lights and a user clip plane
