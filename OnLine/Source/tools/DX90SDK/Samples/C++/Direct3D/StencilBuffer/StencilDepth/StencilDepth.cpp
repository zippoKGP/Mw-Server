...
HRESULT CMyD3DApplication::FrameMove()
{
    ...
    D3DXVECTOR3 vAxis( 1.0f, 1.0f, 0.0f );
    D3DXMatrixRotationAxis( &m_matWorldMatrix, &vAxis, m_fTime/2  );      
...
VOID CMyD3DApplication::ShowDepthComplexity()
{
    ...
    m_pd3dDevice->SetFVF( D3DFVF_XYZRHW );
    m_pd3dDevice->SetStreamSource( 0, m_pBigSquareVB, 0, sizeof(D3DXVECTOR4) );
                                          ...
                                          D3DFORMAT adapterFormat, D3DFORMAT backBufferFormat )
{
    ...
    // Need to support post-pixel processing (for stencil)
