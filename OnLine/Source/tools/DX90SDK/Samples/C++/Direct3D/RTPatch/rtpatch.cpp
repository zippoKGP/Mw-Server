...
const DWORD CUSTOMVERTEX::FVF = D3DFVF_XYZ;
...
class CMyD3DApplication : public CD3DApplication
{
    ...
    LPDIRECT3DVERTEXDECLARATION9        m_pVDeclaration;  // Vertex declaration
...
HRESULT CMyD3DApplication::Render()
{
    ...
    if( SUCCEEDED( m_pd3dDevice->BeginScene() ) )
    {
        ...
        m_pd3dDevice->SetVertexDeclaration( m_pVDeclaration );
...
HRESULT CMyD3DApplication::InitDeviceObjects()
{
    ...
    if( FAILED( m_pd3dDevice->CreateVertexBuffer( numVerts*sizeof(CUSTOMVERTEX),
        D3DUSAGE_RTPATCHES, CUSTOMVERTEX::FVF, D3DPOOL_MANAGED, &m_pVB, NULL ) ) )
    {
        return E_FAIL;
    }
    ...
    D3DVERTEXELEMENT9 decl[] =
    {
        ...
        { 0, 0, D3DDECLTYPE_FLOAT3, D3DDECLMETHOD_CROSSUV, D3DDECLUSAGE_NORMAL, 0 },
        D3DDECL_END()
    };
    hr = m_pd3dDevice->CreateVertexDeclaration( decl, &m_pVDeclaration );
    if( FAILED( hr ) )
        return hr;
...
HRESULT CMyD3DApplication::RestoreDeviceObjects()
{
    ...
    D3DXVECTOR3 vFrom( 0.0f, 3.0f,-400.0f );
...
{
    // There is no software vertex processing support for RT patches
