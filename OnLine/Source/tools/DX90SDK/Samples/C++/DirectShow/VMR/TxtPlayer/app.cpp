...
#ifdef UNICODE
                wsprintfA(sz, "%ls\0", FormatRefTime(szFmt, rt));
#else
                wsprintfA(sz, "%s\0",  FormatRefTime(szFmt, rt));
#endif
                //
    ...
    )
{
    ...
    wsprintf(sz, TEXT("Length: %s\0"), FormatRefTime(szFmt, rt));
    ...
    )
{
    ...
    wsprintf(sz, TEXT("Elapsed: %s\0"), FormatRefTime(szFmt, rt));
    ...
    )
{
    ...
    {
        wsprintf(sz,TEXT("%s\0"),(LPCTSTR) CDisp((LONGLONG) rt,CDISP_DEC));
        return sz;
    }
    ...
    wsprintf(sz, TEXT("%02d:%02d:%02d h:m:s\0"),hrs, mins, secs);
