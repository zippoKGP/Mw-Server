...
#define CLASSNAME   TEXT("DirectShow Texture3D Sample")
...
VOID SetupMatrices()
{
    ...
    D3DXMatrixRotationX( &matWorld, (FLOAT)timeGetTime()/2000.0f );
...
INT WINAPI WinMain( HINSTANCE hInst, HINSTANCE hInstPrev, LPSTR lpCmdLine, INT nCmdShow)
{
    ...
    g_hWnd = CreateWindow( CLASSNAME, TEXT("DirectShow Texture3D Sample"),
