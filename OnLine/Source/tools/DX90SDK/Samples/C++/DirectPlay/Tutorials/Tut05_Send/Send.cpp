...
// File: Send.cpp
//
// Desc: This tutorial adds data transfer functionality.
//
...
// Global constants
//-----------------------------------------------------------------------------
const DWORD TUT05_SEND_PORT = 2605; // The default port number
...
DWORD                g_dwLocalPort     = TUT05_SEND_PORT; // Host port
DWORD                g_dwRemotePort    = TUT05_SEND_PORT; // Connect port
