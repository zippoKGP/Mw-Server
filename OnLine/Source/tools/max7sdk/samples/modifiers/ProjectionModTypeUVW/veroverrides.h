#define MAXVER_INTERNALNAME "ProjectionModTypeUVW\0"//should be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "ProjectionModTypeUVW.dlm\0"//should be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "ProjectionModTypeUVW\0"//should be overidden on a per-dll level
