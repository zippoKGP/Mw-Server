...
#define MAXVER_INTERNALNAME "morphByBone\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "morphByBone.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Skin Morph Modifier (core plugin)\0"//should  be overidden on a per-dll level
