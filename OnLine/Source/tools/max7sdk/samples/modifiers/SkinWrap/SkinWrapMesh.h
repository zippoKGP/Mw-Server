...
//published functions		 
		...
		void BuildParamData(Object *obj,LocalMeshData *localData,int wrapIndex, INode *node,Matrix3 meshTM,Matrix3 baseTM, float threshold);
		void BuildParamDataForce(Object *obj,LocalMeshData *localData,int wrapIndex, INode *node,Matrix3 meshTM,Matrix3 baseTM, float threshold, BitArray pointsToProcess);
