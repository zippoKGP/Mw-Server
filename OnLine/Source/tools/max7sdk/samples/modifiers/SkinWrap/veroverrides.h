...
#define MAXVER_INTERNALNAME "SkinWrap\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "SkinWrap.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Indirect Skinning based Deformer\0"//should  be overidden on a per-dll level
