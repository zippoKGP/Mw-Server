...
#define MAXVER_INTERNALNAME "RenderableSpline\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "RendSpline.dlm\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Renderable Spline modifier (plugin)\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: Alexander.Bicalho\0"//should  be overidden on a per-dll level
