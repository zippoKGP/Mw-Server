    ...
    ,public ILightManager
{
	...
	// I deal with textures seperately to other elements - they remain persistant.
	Tab<TextureElement* > textureCache;
...
public:
	...
	TextureElement(D3DXHANDLE handle,TCHAR * filename);
	~TextureElement();
	bool SetValue(LPD3DXEFFECT pEffect, IParamBlock2 * pblock);
