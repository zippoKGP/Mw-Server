...
void mrShaderListShader::TranslateParameters(imrShader* shader, TimeValue t, Interval& valid) {
...
BOOL mrShaderListShader::mrShaderListShader_UserDlgProc::DlgProc(TimeValue t, IParamMap2 *map, HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam) {
