...
public:
	...
	static HMODULE hXmlMtlDllModule;
...
public:
	...
	STDMETHOD(FindItemKey)(/*[in]*/ DWORD key, /*[out, retval]*/ IMaxMaterial **ppMtl);
public :
...
private:
	...
	typedef std::map<DWORD, MtlWrapper*> ifxClxnType;
...
public:
	...
	CMaxMaterial* findItemKey(DWORD key);
	...
	void OnMtlDeleted(IMaxMaterial *pMtl, DWORD key);

	//consider refactoring to take c++ type rather than ip
	bool AddMtl(MtlWrapper* pMtl, DWORD key);
