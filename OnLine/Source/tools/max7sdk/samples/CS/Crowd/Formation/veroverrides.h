#define MAXVER_INTERNALNAME "Formation\0"//should be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "Formation.dlo\0"//should be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Formation\0"//should be overidden on a per-dll level
