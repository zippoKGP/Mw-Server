...
class ReactionDlg : public ReferenceMaker, public TimeChangeCallback {
	public:
		...
		RefTargetHandle GetReference(int i) {if (i == 0) return GetReactionManager(); return NULL; }  //return iCCtrl;
		void SetReference(int i, RefTargetHandle rtarg) {  } //if (i == 1) iCCtrl = (ICurveCtl*)rtarg;
