...
#define MAXVER_INTERNALNAME "EditPolyMod\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "EditPolyMod.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Edit Poly Modifier\0"//should  be overidden on a per-dll level
