...
BOOL EditPolyPaintDeformDlgProc::DlgProc (TimeValue t, IParamMap2 *pmap, HWND hWnd,
...
void EditPolyMod::ApplyPaintDeform( MeshPaintHost* host ) {
	EditPolyData* modData = static_cast<EditPolyData*>(host);
...
void EditPolyMod::RevertPaintDeform( MeshPaintHost* host ) {
	EditPolyData* modData = static_cast<EditPolyData*>(host);
