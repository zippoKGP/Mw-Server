...
private:
	...
	static IParamMap2 *pSelect, *pSoftsel, *pGeom, *pSubdivision, *pSurface, *pDisplacement, *pPaintDeform;
	static IParamMap2 *pSubobjControls;
	static bool rsSelect, rsSoftsel, rsGeom, rsSubdivision, rsSurface, rsDisplacement, rsPaintDeform;
...
public:
	...
	int Size () { return 2*sizeof(void *) + 23*sizeof (Tab<int>) + sizeof (MNMesh) + 4*sizeof(Tab<int> *) + 8*sizeof(int); }
	void MyDebugPrint ();
};
...
public:
	...
	int Size () { return 5*sizeof(void *) + 2*sizeof(BitArray) + sizeof(bool) + 3*sizeof(int) + 6*sizeof(Tab<int>); }
};
...
public:
	...
	int Size() { return sizeof(Tab<int>) + sizeof(Tab<MNFace>) + sizeof(Tab<MNMapFace *>) + 2*sizeof(void *); }
};
