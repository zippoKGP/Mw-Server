...
#define MAXVER_INTERNALNAME "ExposeTransformObj\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "ExposeTransform.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Expose Transform helper object (plugin)\0"//should  be overidden on a per-dll level
