...
static ParamBlockDesc2 exposetransform_expose_blk (
	...
	// params
	pb_localeuler, 		_T("localEuler"), 		TYPE_POINT3, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_LOCALEULER, 
		end,
	pb_localeulerx, 	_T("localEulerX"), 		TYPE_ANGLE, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_LOCALEULERX, 
		end,
	pb_localeulery, 	_T("localEulerY"), 		TYPE_ANGLE, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_LOCALEULERY, 
		end,
	pb_localeulerz, 	_T("localEulerZ"), 		TYPE_ANGLE, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_LOCALEULERZ, 
		end,
	pb_worldeuler, 		_T("worldEuler"), 		TYPE_POINT3, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_WORLDEULER, 
		end,
	pb_worldeulerx, 	_T("worldEulerX"), 		TYPE_ANGLE, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_WORLDEULERX, 
		end,
	pb_worldeulery, 	_T("worldEulerY"), 		TYPE_ANGLE, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_WORLDEULERY, 
		end,
	pb_worldeulerz, 	_T("worldEulerZ"), 		TYPE_ANGLE, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_WORLDEULERZ, 
		end,
	pb_localposition, 	_T("localPosition"), 	TYPE_POINT3, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_LOCALPOSITION, 
		end,
	pb_localpositionx, 	_T("localPositionX"), 	TYPE_WORLD, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_LOCALPOSITIONX, 
		end,
	pb_localpositiony, 	_T("localpositionY"), 	TYPE_WORLD, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_LOCALPOSITIONY, 
		end,
	pb_localpositionz, 	_T("localPositionZ"), 	TYPE_WORLD, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_LOCALPOSITIONZ, 
		end,
	pb_worldposition, 	_T("worldPosition"), 	TYPE_POINT3, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_WORLDPOSITION, 
		end,
	pb_worldpositionx, 	_T("worldPositionX"), 	TYPE_WORLD, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_WORLDPOSITIONX, 
		end,
	pb_worldpositiony, 	_T("worldPositionY"), 	TYPE_WORLD, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_WORLDPOSITIONY, 
		end,
	pb_worldpositionz, 	_T("worldPositionZ"), 	TYPE_WORLD, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_WORLDPOSITIONZ, 
		end,
	pb_distance, 	_T("distance"),				 TYPE_FLOAT,	P_ANIMATABLE|P_TRANSIENT, 	IDS_DISTANCE, 
		end,
	pb_worldboundingbox_size, 	_T("worldBoundingBoxSize"), TYPE_POINT3, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_WORLDBOUNDINGBOX_SIZE, 
		end,
	pb_worldboundingbox_width, 	_T("worldBoundingBoxWidth"), TYPE_FLOAT, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_WORLDBOUNDINGBOX_WIDTH, 
		end,
	pb_worldboundingbox_length,	_T("worldBoundingBoxLength"), TYPE_FLOAT, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_WORLDBOUNDINGBOX_LENGTH, 
		end,
	pb_worldboundingbox_height,	_T("worldBoundingBoxHeight"), TYPE_FLOAT, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_WORLDBOUNDINGBOX_HEIGHT, 
		end,
	pb_angle, 	_T("angle"), TYPE_ANGLE, 	P_ANIMATABLE|P_TRANSIENT, 	IDS_ANGLE, 
		end,
	end
	);
...
RefTargetHandle ExposeTransform::Clone(RemapDir& remap) 
	...
	newob->ReplaceReference(PBLOCK_EXPOSE, pblock_expose->Clone(remap));
	newob->ReplaceReference(PBLOCK_INFO, pblock_info->Clone(remap));
	newob->ReplaceReference(PBLOCK_DISPLAY, pblock_display->Clone(remap));
	newob->ReplaceReference(PBLOCK_OUTPUT, pblock_output->Clone(remap));
