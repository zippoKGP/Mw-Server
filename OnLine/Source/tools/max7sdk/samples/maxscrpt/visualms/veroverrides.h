...
#define MAXVER_INTERNALNAME "VisualMS\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "VisualMS.dlu\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Visual MAXScript\0"//should  be overidden on a per-dll level
