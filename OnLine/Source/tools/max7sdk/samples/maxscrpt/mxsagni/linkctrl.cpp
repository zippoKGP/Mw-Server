...
{
	LinkControl *ctrl = (LinkControl*)GetWindowLongPtr(hWnd, GWLP_USERDATA);
...
void LinkControl::SetText(TCHAR *text)
{
	...
	GetTextExtentPoint32(parent_rollout->rollout_dc, text, strlen(text), &size);
