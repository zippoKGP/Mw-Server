...
#define MAXVER_INTERNALNAME "MXSAgni\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "MXSAgni.dlx\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MXSAgni\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: larry.minton\0"//should  be overidden on a per-dll level
