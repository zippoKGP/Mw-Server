...
// ============================================================================
// chamferVerts <Poly poly> <vertlist> <float amount>
Value*
polyop_chamferVerts_cf(Value** arg_list, int count)
{
	...
	if (epi) {
		...
		epi->LocalDataChanged(PART_TOPO|PART_SELECT); // needed to force invalidation of temp data
		epi->EpfnChamferVertices(arg_list[2]->to_float(), MAXScript_time());
	}
	return &ok;
}

// ============================================================================
// chamferEdges <Poly poly> <edgelist> <float amount>
Value*
polyop_chamferEdges_cf(Value** arg_list, int count)
{
	...
	if (epi) {
		...
		epi->LocalDataChanged(PART_TOPO|PART_SELECT); // needed to force invalidation of temp data
		epi->EpfnChamferEdges(arg_list[2]->to_float(), MAXScript_time());
	}
	return &ok;
}
