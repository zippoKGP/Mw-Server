...
#define MAXVER_INTERNALNAME "MXSActiveX\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "MXSActiveX.DLX\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MaxSript ActiveX Engine\0"//should  be overidden on a per-dll level
