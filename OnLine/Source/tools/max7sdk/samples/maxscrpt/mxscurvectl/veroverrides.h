...
#define MAXVER_INTERNALNAME "MXSCurveCtl\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "MXSCurveCtl.dlx\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MaxScript Curve Control\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH:ravi.karra\0"//should  be overidden on a per-dll level
