...
#define MAXVER_INTERNALNAME "gmax\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "gmax.dlx\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "MAXScript extension for gmax\0"//should  be overidden on a per-dll level
#define MAXVER_COMMENTS "TECH: simon.feltman\0"//should  be overidden on a per-dll level
