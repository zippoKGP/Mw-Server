...
// ============================================================================
#include "definsfn.h"
	def_visible_primitive(isSpace, "isSpace");
	def_visible_primitive(trimLeft, "trimLeft");
	def_visible_primitive(trimRight, "trimRight");
	def_visible_primitive(readToken, "readToken");
	def_visible_primitive(peekToken, "peekToken");
	def_visible_primitive(skipSpace, "skipSpace");
	def_visible_primitive(getFileSize, "getFileSize");
