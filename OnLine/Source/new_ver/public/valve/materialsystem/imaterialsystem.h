...
//
// $Header: /home/cvsroot/mythwar/src_main/public/valve/materialsystem/imaterialsystem.h,v 1.2 2005/03/12 15:25:58 andy Exp $
// $NoKeywords: $
//
...
//	virtual int					GetLightmapPageIDForSortID( int sortID ) = 0;
	...
	//
	virtual IMaterialInternal* AddMaterial( char const* pName )	= 0;

	virtual void RemoveMaterial( IMaterialInternal* pMaterial ) = 0;

//	virtual void DestoryMaterial(IMaterial *pMaterial) = 0;
};
