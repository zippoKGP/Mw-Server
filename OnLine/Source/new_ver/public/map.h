...
enum
{
	...
	MAP_SRCEEN_WIDTH = 800,
	
	MAP_SRCEEN_HEIGHT = 600,

	MAX_MAP_WIDTH = 20,			//最大地图宽（屏幕为单位）
	MAX_MAP_HEIGHT = 20,		//最大地图高（屏幕为单位）
	
	

	MAP_VERSION = 10101,		//文件版本
};
...
typedef struct MAP_JPG_HEAD_STRUCT
{
	SLONG columns;                // 地圖列
	SLONG rows;					// 地圖行
	SLONG array_len[MAX_MAP_HEIGHT][MAX_MAP_WIDTH];
	SLONG img_date_offset;		 //地图图像片
