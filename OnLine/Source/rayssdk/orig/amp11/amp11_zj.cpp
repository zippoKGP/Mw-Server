...
//====================================================================================
// our simply main function
//====================================================================================
int test_play_mp3(char *mp3_filename);
...
int main(int argc, char **argv)
{
	...
	if(argc < 2)
	{
		printf("USAGE: AMP filename.mp3\n");
		return -1;
	}
	mp3_filename = argv[1];
	test_play_mp3(mp3_filename);
	return 0;
}
...
int test_play_mp3(char *mp3_filename)
{
	...
	while (!dec.eof())
	{
		//TODO: con control need to be cancel later...
		{//------------------------------------------------------------------------
			unsigned char key=0;
