...
#define	NET_MSG_SYSTEM_CHANNEL					0x00040087  //系统频道，客户端(worldbase)发送

//参数为用户自己的id
#define	NET_MSG_CHAT_CURRENT_RETURN				0x00040088 //获取当前频道用户id
#define	NET_MSG_CHAT_CURRENT					0x00040089 //返回当前频道用户id
#define	NET_MSG_WORLD_CHANNEL_CHECK_RETURN		0x00040090  //世界频道，服务器端发送给worldbase
#define	NET_MSG_WORLD_CHANNEL_CHECK				0x00040091  //世界频道，客户端(worldbase)发送
...
//------------禁言，ben add in 2005-05-11-----------------------------------------------------------
//参数为要禁言的玩家id，后面跟随禁言的时间，类型为DWORD，0表示解禁。
#define NET_MSG_CHAT_STOP_TALK						0x00040270
