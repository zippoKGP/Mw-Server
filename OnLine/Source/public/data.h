...
// ---------------- Version Data ----------------------
#define GAME_VERSION0	1
#define GAME_VERSION1	0
#define GAME_VERSION2	16
...
#define MAX_ITEM_NAME_LENGTH						14		// 物品名称长度
...
{
	{	"衰老术一阶",  	"衰老一人数回合。",    	     4,	    15,	       0.080,	     3,	     1,	     1,	     1,	   205,	     1	},
	{	"衰老术二阶",  	"衰老多人数回合。",    	     4,	    45,	       0.130,	     2,	     2,	     1,	     1,	     1,	   206	},
	{	"衰老术三阶",  	"衰老一人数回合。",    	     4,	   250,	       0.120,	     3,	     1,	     1,	     1,	   207,	     1	},
	{	"衰老术四阶",  	"衰老多人数回合。",    	     4,	   750,	       0.170,	     2,	     3,	     1,	     1,	     1,	   208	},
	{	"毒系一阶",    	"使一人中毒数回合。",  	     3,	    15,	       0.080,	     3,	     1,	     1,	     1,	   201,	     1	},
	{	"毒系二阶",    	"使多人中毒数回合。",  	     3,	    45,	       0.130,	     2,	     2,	     1,	     1,	     1,	   202	},
	{	"毒系三阶",    	"使一人中毒数回合。",  	     3,	   250,	       0.120,	     3,	     1,	     1,	     1,	   203,	     1	},
	{	"毒系四阶",    	"使多人中毒数回合。",  	     3,	   750,	       0.170,	     2,	     3,	     1,	     1,	     1,	   204	},
	{	"混乱术一阶",  	"混乱一人数回合。",    	     1,	    15,	       0.080,	     3,	     1,	     1,	     1,	   209,	     1	},
	{	"混乱术二阶",  	"混乱多人数回合。",    	     1,	    45,	       0.130,	     2,	     2,	     1,	     1,	     1,	   210	},
	{	"混乱术三阶",  	"混乱一人数回合。",    	     1,	   250,	       0.120,	     3,	     1,	     1,	     1,	   211,	     1	},
	{	"混乱术四阶",  	"混乱多人数回合。",    	     1,	   750,	       0.170,	     2,	     3,	     1,	     1,	     1,	   212	},
	{	"催眠术一阶",  	"使一人昏睡数回合。",  	     2,	    15,	       0.080,	     3,	     1,	     1,	     1,	   213,	     1	},
	{	"催眠术二阶",  	"使多人昏睡数回合。",  	     2,	    45,	       0.130,	     2,	     2,	     1,	     1,	     1,	   214	},
	{	"催眠术三阶",  	"使一人昏睡数回合。",  	     2,	   250,	       0.120,	     3,	     1,	     1,	     1,	   215,	     1	},
	{	"催眠术四阶",  	"使多人昏睡数回合。",  	     2,	   750,	       0.170,	     2,	     3,	     1,	     1,	     1,	   216	},
	{	"石化术一阶",  	"使一人石化数回合。",  	     0,	    15,	       0.080,	     3,	     1,	     1,	     1,	   217,	     1	},
	{	"石化术二阶",  	"使多人石化数回合。",  	     0,	    45,	       0.130,	     2,	     2,	     1,	     1,	     1,	   218	},
	{	"石化术三阶",  	"使一人石化数回合。",  	     0,	   250,	       0.120,	     3,	     1,	     1,	     1,	   219,	     1	},
	{	"石化术四阶",  	"使多人石化数回合。",  	     0,	   750,	       0.170,	     2,	     3,	     1,	     1,	     1,	   220	},
	{	"解除混乱一阶",	"解除一人混乱。",      	    34,	    20,	       0.080,	     0,	     1,	     0,	     1,	   233,	     1	},
	{	"解除混乱二阶",	"解除多人混乱。",      	    34,	    60,	       0.130,	     0,	     2,	     0,	     1,	     1,	   234	},
	{	"解除混乱三阶",	"解除一人混乱。",      	    34,	   450,	       0.120,	     0,	     1,	     0,	     1,	   235,	     1	},
	{	"解除混乱四阶",	"解除多人混乱。",      	    34,	  1400,	       0.170,	     0,	     3,	     0,	     1,	     1,	   236	},
	{	"解除石化一阶",	"解除一人石化。",      	    33,	    20,	       0.080,	     0,	     1,	     0,	     1,	   233,	     1	},
	{	"解除石化二阶",	"解除多人石化。",      	    33,	    60,	       0.130,	     0,	     2,	     0,	     1,	     1,	   234	},
	{	"解除石化三阶",	"解除一人石化。",      	    33,	   450,	       0.120,	     0,	     1,	     0,	     1,	   235,	     1	},
	{	"解除石化四阶",	"解除多人石化。",      	    33,	  1400,	       0.170,	     0,	     3,	     0,	     1,	     1,	   236	},
	{	"魔弓一阶",    	"对一人多次攻击。",    	    12,	    20,	       0.060,	     0,	     1,	     1,	     1,	   221,	     1	},
	{	"魔弓二阶",    	"对多人数次攻击。",    	    12,	    60,	       0.100,	     0,	     2,	     1,	     1,	     1,	   222	},
	{	"魔弓三阶",    	"对一人多次攻击。",    	    12,	   450,	       0.120,	     0,	     1,	     1,	     1,	   223,	     1	},
	{	"魔弓四阶",    	"对多人数次攻击。",    	    12,	  1400,	       0.160,	     0,	     3,	     1,	     1,	     1,	   224	},
	{	"暗影一阶",    	"对一人多次攻击。",    	    12,	    20,	       0.060,	     0,	     1,	     1,	     1,	   285,	     1	},
	{	"暗影二阶",    	"对多人数次攻击。",    	    12,	    60,	       0.100,	     0,	     2,	     1,	     1,	     1,	   286	},
	{	"暗影三阶",    	"对一人多次攻击。",    	    12,	   450,	       0.120,	     0,	     1,	     1,	     1,	   287,	     1	},
	{	"暗影四阶",    	"对多人数次攻击。",    	    12,	  1400,	       0.160,	     0,	     3,	     1,	     1,	     1,	   288	},
	{	"速度提升一阶",	"单体加速。",          	    13,	    20,	       0.080,	     3,	     1,	     0,	     1,	   225,	     1	},
	{	"速度提升二阶",	"群体加速。",          	    13,	    60,	       0.130,	     2,	     2,	     0,	     1,	     1,	   226	},
	{	"速度提升三阶",	"单体加速。",          	    13,	   450,	       0.120,	     3,	     1,	     0,	     1,	   227,	     1	},
	{	"速度提升四阶",	"群体加速。",          	    13,	   800,	       0.170,	     2,	     3,	     0,	     1,	     1,	   228	},
	{	"治愈术一阶",  	"单体回复体力。",      	    14,	    45,	       0.080,	     0,	     1,	     0,	     1,	   229,	     1	},
	{	"治愈术二阶",  	"群体回复体力。",      	    14,	   140,	       0.130,	     0,	     2,	     0,	     1,	     1,	   230	},
	{	"治愈术三阶",  	"单体回复体力。",      	    14,	   850,	       0.120,	     0,	     1,	     0,	     1,	   231,	     1	},
	{	"治愈术四阶",  	"群体回复体力。",      	    14,	  1200,	       0.170,	     0,	     3,	     0,	     1,	     1,	   232	},
	{	"火系法术一阶",	"单体火系攻击。",      	    23,	    35,	       0.100,	     0,	     1,	     1,	     1,	   237,	     1	},
	{	"火系法术二阶",	"群体火系攻击。",      	    23,	    50,	       0.150,	     0,	     2,	     1,	     1,	     1,	   238	},
	{	"火系法术三阶",	"单体火系攻击。",      	    23,	   350,	       0.180,	     0,	     1,	     1,	     1,	   239,	     1	},
	{	"火系法术四阶",	"群体火系攻击。",      	    23,	  1000,	       0.230,	     0,	     3,	     1,	     1,	     1,	   240	},
	{	"水系法术一阶",	"单体水系攻击。",      	    22,	    35,	       0.100,	     0,	     1,	     1,	     1,	   241,	     1	},
	{	"水系法术二阶",	"群体水系攻击。",      	    22,	    50,	       0.150,	     0,	     2,	     1,	     1,	     1,	   242	},
	{	"水系法术三阶",	"单体火系攻击。",      	    22,	   350,	       0.180,	     0,	     1,	     1,	     1,	   243,	     1	},
	{	"水系法术四阶",	"群体火系攻击。",      	    22,	  1000,	       0.230,	     0,	     3,	     1,	     1,	     1,	   244	},
	{	"暗系法术一阶",	"单体暗系攻击。",      	    20,	    35,	       0.100,	     0,	     1,	     1,	     1,	   245,	     1	},
	{	"暗系法术二阶",	"群体暗系攻击。",      	    20,	    50,	       0.150,	     0,	     2,	     1,	     1,	     1,	   246	},
	{	"暗系法术三阶",	"单体暗系攻击。",      	    20,	   350,	       0.180,	     0,	     1,	     1,	     1,	   247,	     1	},
	{	"暗系法术四阶",	"群体暗系攻击。",      	    20,	  1000,	       0.230,	     0,	     3,	     1,	     1,	     1,	   248	},
	{	"光系法术一阶",	"单体光系攻击。",      	    21,	    35,	       0.100,	     0,	     1,	     1,	     1,	   249,	     1	},
	{	"光系法术二阶",	"群体光系攻击。",      	    21,	    50,	       0.150,	     0,	     2,	     1,	     1,	     1,	   250	},
	{	"光系法术三阶",	"单体光系攻击。",      	    21,	   350,	       0.180,	     0,	     1,	     1,	     1,	   251,	     1	},
	{	"光系法术四阶",	"群体光系攻击。",      	    21,	  1000,	       0.230,	     0,	     3,	     1,	     1,	     1,	   252	},
	{	"死亡宣告一阶",	"单体死亡宣告。",      	    24,	    35,	       0.100,	     9,	     1,	     1,	     1,	   253,	     1	},
	{	"死亡宣告二阶",	"群体死亡宣告。",      	    24,	    50,	       0.150,	    10,	     2,	     1,	     1,	     1,	   254	},
	{	"死亡宣告三阶",	"单体死亡宣告。",      	    24,	   350,	       0.180,	     6,	     1,	     1,	     1,	   255,	     1	},
	{	"死亡宣告四阶",	"群体死亡宣告。",      	    24,	  1000,	       0.230,	     8,	     3,	     1,	     1,	     1,	   256	},
	{	"威力提升一阶",	"单体提升攻防数回合。",	    10,	    10,	       0.040,	     3,	     1,	     0,	     1,	   257,	     1	},
	{	"威力提升二阶",	"群体提升攻防数回合。",	    10,	    15,	       0.090,	     2,	     2,	     0,	     1,	     1,	   258	},
	{	"威力提升三阶",	"单体提升攻防数回合。",	    10,	   200,	       0.100,	     3,	     1,	     0,	     1,	   259,	     1	},
	{	"威力提升四阶",	"群体提升攻防数回合。",	    10,	   300,	       0.150,	     2,	     3,	     0,	     1,	     1,	   260	},
	{	"抗性提升一阶",	"单体提升抗性数回合。",	    11,	    10,	       0.040,	     3,	     1,	     0,	     1,	   281,	     1	},
	{	"抗性提升二阶",	"群体提升抗性数回合。",	    11,	    15,	       0.090,	     2,	     2,	     0,	     1,	     1,	   282	},
	{	"抗性提升三阶",	"单体提升抗性数回合。",	    11,	   200,	       0.100,	     3,	     1,	     0,	     1,	   283,	     1	},
	{	"抗性提升四阶",	"群体提升抗性数回合。",	    11,	   300,	       0.150,	     2,	     3,	     0,	     1,	     1,	   284	},
	{	"吸收术一阶",  	"单体吸收。",          	    30,	    10,	       0.040,	     0,	     1,	     1,	     1,	   269,	     1	},
	{	"吸收术二阶",  	"群体吸收。",          	    30,	    15,	       0.090,	     0,	     2,	     1,	     1,	     1,	   270	},
	{	"吸收术三阶",  	"单体吸收。",          	    30,	   200,	       0.100,	     0,	     1,	     1,	     1,	   271,	     1	},
	{	"吸收术四阶",  	"群体吸收。",          	    30,	   300,	       0.150,	     0,	     3,	     1,	     1,	     1,	   272	},
	{	"物理反弹一阶",	"单体物理反射。",      	    31,	    10,	       0.040,	     3,	     1,	     0,	     1,	   261,	     1	},
	{	"物理反弹二阶",	"群体物理反射。",      	    31,	    15,	       0.090,	     2,	     2,	     0,	     1,	     1,	   262	},
	{	"物理反弹三阶",	"单体物理反射。",      	    31,	   200,	       0.100,	     3,	     1,	     0,	     1,	   263,	     1	},
	{	"物理反弹四阶",	"群体物理反射。",      	    31,	   300,	       0.150,	     2,	     3,	     0,	     1,	     1,	   264	},
	{	"魔法反射一阶",	"单体法术反射。",      	    32,	    10,	       0.040,	     3,	     1,	     0,	     1,	   265,	     1	},
	{	"魔法反射二阶",	"群体法术反射。",      	    32,	    15,	       0.090,	     2,	     2,	     0,	     1,	     1,	   266	},
	{	"魔法反射三阶",	"单体法术反射。",      	    32,	   200,	       0.100,	     3,	     1,	     0,	     1,	   267,	     1	},
	{	"魔法反射四阶",	"群体法术反射。",      	    32,	   300,	       0.150,	     2,	     3,	     0,	     1,	     1,	   268	},
	{	"衰老术一阶",  	"衰老一人数回合。",    	     4,	    15,	       0.000,	     5,	     1,	     1,	     0,	   205,	     1	},
	{	"衰老术二阶",  	"衰老多人数回合。",    	     4,	    45,	       0.000,	     4,	     3,	     1,	     0,	     1,	   206	},
	{	"衰老术三阶",  	"衰老一人数回合。",    	     4,	   250,	       0.000,	     7,	     1,	     1,	     0,	   207,	     1	},
	{	"衰老术四阶",  	"衰老多人数回合。",    	     4,	   750,	       0.000,	     6,	     5,	     1,	     0,	     1,	   208	},
	{	"毒系一阶",    	"使一人中毒数回合。",  	     3,	    15,	       0.000,	     5,	     1,	     1,	     0,	   201,	     1	},
	{	"毒系二阶",    	"使多人中毒数回合。",  	     3,	    45,	       0.000,	     4,	     3,	     1,	     0,	     1,	   202	},
	{	"毒系三阶",    	"使一人中毒数回合。",  	     3,	   250,	       0.000,	     7,	     1,	     1,	     0,	   203,	     1	},
	{	"毒系四阶",    	"使多人中毒数回合。",  	     3,	   750,	       0.000,	     6,	     5,	     1,	     0,	     1,	   204	},
	{	"魔弓一阶",    	"对一人多次攻击。",    	    12,	    20,	       0.000,	     0,	     1,	     1,	     0,	   221,	     1	},
	{	"魔弓二阶",    	"对多人数次攻击。",    	    12,	    60,	       0.000,	     0,	     3,	     1,	     0,	     1,	   222	},
	{	"魔弓三阶",    	"对一人多次攻击。",    	    12,	   450,	       0.000,	     0,	     1,	     1,	     0,	   223,	     1	},
	{	"魔弓四阶",    	"对多人数次攻击。",    	    12,	  1400,	       0.000,	     0,	     5,	     1,	     0,	     1,	   224	},
	{	"暗影一阶",    	"对一人多次攻击。",    	    12,	    20,	       0.000,	     0,	     1,	     1,	     0,	   285,	     1	},
	{	"暗影二阶",    	"对多人数次攻击。",    	    12,	    60,	       0.000,	     0,	     3,	     1,	     0,	     1,	   286	},
	{	"暗影三阶",    	"对一人多次攻击。",    	    12,	   450,	       0.000,	     0,	     1,	     1,	     0,	   287,	     1	},
	{	"暗影四阶",    	"对多人数次攻击。",    	    12,	  1400,	       0.000,	     0,	     5,	     1,	     0,	     1,	   288	},
	{	"速度提升一阶",	"单体加速。",          	    13,	    20,	       0.000,	     5,	     1,	     0,	     0,	   225,	     1	},
	{	"速度提升二阶",	"群体加速。",          	    13,	    60,	       0.000,	     4,	     3,	     0,	     0,	     1,	   226	},
	{	"速度提升三阶",	"单体加速。",          	    13,	   450,	       0.000,	     7,	     1,	     0,	     0,	   227,	     1	},
	{	"速度提升四阶",	"群体加速。",          	    13,	   800,	       0.000,	     6,	     5,	     0,	     0,	     1,	   228	},
	{	"火系法术一阶",	"单体火系攻击。",      	    23,	    35,	       0.000,	     0,	     1,	     1,	     0,	   237,	     1	},
	{	"火系法术二阶",	"群体火系攻击。",      	    23,	    50,	       0.000,	     0,	     3,	     1,	     0,	     1,	   238	},
	{	"火系法术三阶",	"单体火系攻击。",      	    23,	   350,	       0.000,	     0,	     1,	     1,	     0,	   239,	     1	},
	{	"火系法术四阶",	"群体火系攻击。",      	    23,	  1000,	       0.000,	     0,	     4,	     1,	     0,	     1,	   240	},
	{	"水系法术一阶",	"单体水系攻击。",      	    22,	    35,	       0.000,	     0,	     1,	     1,	     0,	   241,	     1	},
	{	"水系法术二阶",	"群体水系攻击。",      	    22,	    50,	       0.000,	     0,	     3,	     1,	     0,	     1,	   242	},
	{	"水系法术三阶",	"单体火系攻击。",      	    22,	   350,	       0.000,	     0,	     1,	     1,	     0,	   243,	     1	},
	{	"水系法术四阶",	"群体火系攻击。",      	    22,	  1000,	       0.000,	     0,	     4,	     1,	     0,	     1,	   244	},
	{	"暗系法术一阶",	"单体暗系攻击。",      	    20,	    35,	       0.000,	     0,	     1,	     1,	     0,	   245,	     1	},
	{	"暗系法术二阶",	"群体暗系攻击。",      	    20,	    50,	       0.000,	     0,	     3,	     1,	     0,	     1,	   246	},
	{	"暗系法术三阶",	"单体暗系攻击。",      	    20,	   350,	       0.000,	     0,	     1,	     1,	     0,	   247,	     1	},
	{	"暗系法术四阶",	"群体暗系攻击。",      	    20,	  1000,	       0.000,	     0,	     4,	     1,	     0,	     1,	   248	},
	{	"光系法术一阶",	"单体光系攻击。",      	    21,	    35,	       0.000,	     0,	     1,	     1,	     0,	   249,	     1	},
	{	"光系法术二阶",	"群体光系攻击。",      	    21,	    50,	       0.000,	     0,	     3,	     1,	     0,	     1,	   250	},
	{	"光系法术三阶",	"单体光系攻击。",      	    21,	   350,	       0.000,	     0,	     1,	     1,	     0,	   251,	     1	},
	{	"光系法术四阶",	"群体光系攻击。",      	    21,	  1000,	       0.000,	     0,	     4,	     1,	     0,	     1,	   252	},
	{	"威力提升一阶",	"单体提升攻防数回合。",	    10,	    10,	       0.000,	     5,	     1,	     0,	     0,	   257,	     1	},
	{	"威力提升二阶",	"群体提升攻防数回合。",	    10,	    15,	       0.000,	     4,	     3,	     0,	     0,	     1,	   258	},
	{	"威力提升三阶",	"单体提升攻防数回合。",	    10,	   200,	       0.000,	     7,	     1,	     0,	     0,	   259,	     1	},
	{	"威力提升四阶",	"群体提升攻防数回合。",	    10,	   300,	       0.000,	     6,	     5,	     0,	     0,	     1,	   260	},
	{	"抗性提升一阶",	"单体提升抗性数回合。",	    11,	    10,	       0.000,	     5,	     1,	     0,	     0,	   281,	     1	},
	{	"抗性提升二阶",	"群体提升抗性数回合。",	    11,	    15,	       0.000,	     4,	     3,	     0,	     0,	     1,	   282	},
	{	"抗性提升三阶",	"单体提升抗性数回合。",	    11,	   200,	       0.000,	     7,	     1,	     0,	     0,	   283,	     1	},
	{	"抗性提升四阶",	"群体提升抗性数回合。",	    11,	   300,	       0.000,	     6,	     5,	     0,	     0,	     1,	   284	},
};
...
/*******************************************************************************************************************}
{																													}
{		Define touch system npc type																				}
{																													}
********************************************************************************************************************/
enum	TOUCH_TYPE_CODE
{
		TOUCH_MACRO_TYPE=				0,			// 点击 NPC
		TOUCH_ATTACK_TYPE=				1,			// 攻击 NPC
		TOUCH_GIVE_TYPE=				2,			// 给与 NPC
		TOUCH_BORN_TYPE=				3,		
};
...
// --- skill for 机械
		...
		SKILL_EFFECT_REMOVE_STONE=						33,			// 解除石化
		SKILL_EFFECT_REMOVE_CHAOS=						34,			// 解除混乱
};
...
typedef struct PUBLIC_TITLE_DATA_STRUCT				// 头衔资料
{
	...
	SLONG start_index;
	SLONG select_index;
	PUBLIC_TITLE_BASE data[MAX_TITLE];
} PUBLIC_TITLE_DATA;
...
typedef struct FIGHT_BASE_DATA_STRUCT				// 战斗基本单元资料
{
	...
	ULONG status;									// 目前人物状态 see enum ( FIGHT_STATUS_CODE )
