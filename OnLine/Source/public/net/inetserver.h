...
public:
	virtual UG_ULONG		init(PINIT_NET_SERCER pInit,FnNetSvr pfnCB,UG_PVOID pvKey) = 0;
	virtual UG_ULONG		shutdown() = 0; //返回0表示正确，否则错误
	virtual UG_ULONG		disconnectPlayer(UG_PVOID pvConnect) = 0;
	...
	virtual UG_ULONG		writeBuffer(UG_PVOID pvConnect,UG_DWORD dwMsgID,UG_DWORD dwParam,UG_PCHAR pchData,UG_ULONG ulLen,DWORD dwOverflow) = 0;
	virtual UG_ULONG		sendData(UG_PVOID pvConnect,UG_DWORD dwMsgID,UG_DWORD dwParam,UG_PCHAR pchData = NULL,UG_ULONG ulLen = 0) = 0;
	virtual UG_ULONG		sendBuffer(UG_PVOID pvConnect,UG_ULONG ulSendSize) = 0;
	virtual UG_ULONG		recvData(UG_PVOID pvConnect,double& dbRecv,double& dbRecvs) = 0;
	virtual UG_ULONG		setPlayer(UG_PVOID pvConnect,UG_PVOID pvPlayer) = 0;
	virtual UG_ULONG		acceptPlayer() = 0;

public:
	virtual UG_INT32		setSocket(UG_INT32 nSend,UG_INT32 nRecv) = 0;
	virtual UG_INT32		setWriteBuffer(UG_INT32 nWrite) = 0;
	virtual UG_INT32		setRecvBuffer(UG_DWORD dwRecv) = 0;
