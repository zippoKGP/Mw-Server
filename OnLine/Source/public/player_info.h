...
#define NET_MSG_PLAYER_MEMBER_LEVEL_UP			0x00030039
#define NET_MSG_PLAYER_MEMBER_LEVEL_UP_RETURN	0x00030039
...
#define NET_MSG_PLAYER_OTHER_DATA				0x00050006
#define NET_MSG_PLAYER_OTHER_DATA_RETURN		0x00050006
...
#define NET_MSG_PLAYER_BAOBAO_BASE_DATA			0x0006000D
#define NET_MSG_PLAYER_BAOBAO_BASE_DATA_RETURN	0x0006000D

#define NET_MSG_PLAYER_BAOBAO_FINAL_DATA		0x0006000E
#define NET_MSG_PLAYER_BAOBAO_FINAL_DATA_RETURN	0x0006000E
...
#define NET_MSG_PLAYER_SKILL_UPDATE				0x000B0005
#define NET_MSG_PLAYER_SKILL_UPDATE_RETURN		0x000B0005
...
struct fight_result_t
{
	...
	fight_magic_data_t *magic;

	char *cust_buf;
};

#define NET_MSG_PLAYER_FIGHT_CHARGE_CONTINUE		0x000C000B
#define NET_MSG_PLAYER_FIGHT_CHARGE_CONTINUE_RETURN	0x000C000B

#define NET_MSG_PLAYER_FIGHT_STATUS					0x000C000C
#define NET_MSG_PLAYER_FIGHT_STATUS_RETURN			0x000C000C

#define NET_MSG_PLAYER_FIGHT_VALUE					0x000C000D
#define NET_MSG_PLAYER_FIGHT_VALUE_RETURN			0x000C000D

#define NET_MSG_PLAYER_FIGHT_PET_CHANGE				0x000C000E
#define NET_MSG_PLAYER_FIGHT_PET_CHANGE_RETURN		0x000C000E

#define NET_MSG_PLAYER_ATTACK_NPC					0x000C000F
#define NET_MSG_PLAYER_ATTACK_NPC_RETURN			0x000C000F

#define NET_MSG_PLAYER_FIGHT_CHANGE_SCENE			0x000C0010
#define NET_MSG_PLAYER_FIGHT_CHANGE_SCENE_RETURN	0x000C0010

#define NET_MSG_PLAYER_NEIGHBOR_START_FIGHT			0x000C0011
#define NET_MSG_PLAYER_NEIGHBOR_START_FIGHT_RETURN	0x000C0011

#define NET_MSG_PLAYER_NEIGHBOR_END_FIGHT			0x000C0012
#define NET_MSG_PLAYER_NEIGHBOR_END_FIGHT_RETURN	0x000C0012

#define NET_MSG_PLAYER_LEAVE_ATTACK_VEIW			0x000C0013
#define NET_MSG_PLAYER_LEAVE_ATTACK_VEIW_RETURN		0x000C0013

#define NET_MSG_PLAYER_CHARGE_LIST					0x000C0014
#define NET_MSG_PLAYER_CHARGE_LIST_RETURN			0x000C0014

#define NET_MSG_PLAYER_FIGHT_ADD_VIEW				0x000E0015
#define NET_MSG_PLAYER_FIGHT_ADD_VIEW_RETURN		0x000E0015
...
#define NET_MSG_PLAYER_PET_USE_ITEM					0x000D0005
#define NET_MSG_PLAYER_PET_USE_ITEM_RETURN			0x000D0005

//-----------------------------------------------------------------------------
//
//-----------------------------------------------------------------------------
#define NET_MSG_PLAYER_FINAL_DATA					0x000E0001
#define NET_MSG_PLAYER_FINAL_DATA_RETURN			0x000E0001

#define NET_MSG_PLAYER_TITLE_LIST					0x000E0002
#define NET_MSG_PLAYER_TITLE_LIST_RETURN			0x000E0002

#define NET_MSG_PLAYER_TITLE_ADD					0x000E0003
#define NET_MSG_PLAYER_TITLE_ADD_RETURN				0x000E0003

#define NET_MSG_PLAYER_TITLE_CHANGE					0x000E0004
#define NET_MSG_PLAYER_TITLE_CHANGE_RETURN			0x000E0004

#define NET_MSG_PLAYER_TITLE_HIDE					0x000E0005
#define NET_MSG_PLAYER_TITLE_HIDE_RETURN			0x000E0005

#define NET_MSG_PLAYER_BASE_DATA					0x000E0006
#define NET_MSG_PLAYER_BASE_DATA_RETURN				0x000E0006

#define NET_MSG_PLAYER_TITLE_DELETE					0x000E0007
#define NET_MSG_PLAYER_TITLE_DELETE_RETURN			0x000E0007


#define NET_MSG_PLAYER_SYSTEM_MESSAGE_RETURN		0x000F0001
