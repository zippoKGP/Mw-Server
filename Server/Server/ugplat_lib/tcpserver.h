...
public: //Server
	UGINT			getEncrypt(UG_PVOID pvConnect,UG_DWORD& dwEncrypt);
...
protected:
	UGDWORD			writeDisconnect(DWORD dwIP,DWORD dwPort,double dbTimes,DWORD dwError,double dbOnlineTimes,int nAverage);
